...
const HowItWorks = () => {
    return (
        <div className='text-center   text-gray-600 p-16  bg-gray-50  space-y-2 '>
            ...
            <div>
                <div className='grid  mt-10 lg:grid-cols-3 grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto'>
                    ...
                    >
                        ...
                        <h1 className='md:text-2xl font-semibold text-xl '>Share Your Job</h1>
                    ...
                    >
                        ...
                        <h1 className='md:text-2xl font-semibold text-xl '>Get Multiple Quotes</h1>
                    ...
                    >
                        ...
                        <h1 className='md:text-2xl font-semibold text-xl '>Pick the Right Pro</h1>
